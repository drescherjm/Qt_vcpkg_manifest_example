...
function(_qt56_internal_setup_deploy_support)
    ...
    if (QT_VERSION_MAJOR EQUAL 6)
        if (NOT $<CONFIG:Debug>)
            ...
            set(qtpaths_prefix "${_QT56_INSTALL_PREFIX}/tools/Qt6/debug/bin")
        endif()
    else()
        set(qtpaths_prefix "${_QT56_INSTALL_PREFIX}/tools/qt5/bin")
        #set(qtpaths_prefix $<IF:$<CONFIG:Debug>,"${_QT56_INSTALL_PREFIX}/tools/qt5/debug/bin","${_QT56_INSTALL_PREFIX}/tools/qt5/bin">)
    endif()
    
    get_property(qt_major_version TARGET "${target}" PROPERTY INTERFACE_QT_MAJOR_VERSION)
    if(qt_major_version)
        set(target_qt56paths_with_major_version_path
            "${qtpaths_prefix}/qtpaths${qt_major_version}${qt_paths_ext}")
        if(EXISTS "${target_qt56paths_with_major_version_path}")
            set(target_qt56paths_path "${target_qt56paths_with_major_version_path}")
        endif()
    endif()

    if(NOT target_qt56paths_path)
        set(target_qt56paths_path_without_version "${qtpaths_prefix}/qtpaths${qt_paths_ext}")
        if(EXISTS "${target_qt56paths_path_without_version}")
            set(target_qt56paths_path "${target_qt56paths_path_without_version}")
        endif()
    endif()
    ...
    if (QT_VERSION_MAJOR EQUAL 5) 
        set(target_qt56qmake_path "${_QT56_INSTALL_PREFIX}/tools/qt5/bin/qmake${qt_paths_ext}")
        set(target_qt56qmake_path_debug "${_QT56_INSTALL_PREFIX}/tools/qt5/debug/bin/qmake${qt_paths_ext}")
    else()
        set(target_qt56qmake_path "")
        set(target_qt56qmake_path_debug "")
    endif()
...
set(__QT_DEPLOY_TARGET_QT_PATHS_PATH \"${target_qt56paths_path}\")
set(__QT_DEPLOY_TARGET_QMAKE_PATH \"$<IF:$<CONFIG:Debug>,${target_qt56qmake_path_debug},${target_qt56qmake_path}>\")
